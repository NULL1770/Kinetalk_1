...
后续补充：已按固定 FaceDiffuser 官方代码重算 ARKit-MBE/LBE/FDD，并完成三个种子的非线性音频条件预测对照。新主表和失败结果见 [ARKIT_EVAL_RESULTS_20260919.md](ARKIT_EVAL_RESULTS_20260919.md)，同条件基线协议见 [ARKIT_BASELINE_PROTOCOL_20260919.md](ARKIT_BASELINE_PROTOCOL_20260919.md)。本页旧 MAE/std gap 是原有诊断，不能改名当作新文献指标。
